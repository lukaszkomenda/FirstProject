...
public class RomanConverterApp {
    private static final Map<Character, Integer> romanSymbols
    ...
    private static boolean doesSymbolsContainsRomanCharacter
            (String roman, int index) {
